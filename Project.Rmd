...
```{r fig.cap="\\label{fig:raw_data}Raw Mammoth snow depth data", fig.height=4, fig.pos="H"}
...
```{r, fig.cap="\\label{fig:resid_plots} Plots of different characteristics of the best model's residuals fitted on the detrended data with missing values excluded", message=FALSE, warning=F}
# auto.arima(detrended)
