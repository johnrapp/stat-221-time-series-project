...
# ts.plot(trended, ylab="Snow depth (in)", main="Snow depth forecast", xlim=c(2011.901, 2017.784))
...
ts.plot(trended, ylab="Snow depth (in)", main="Snow depth forecast", xlim=c(2016.901, 2017.784), ylim=c(0,100))
...
# ts.plot(trended[1:(length(trended) - weeks_omit)], ylab="Snow depth (in)", main="Snow depth forecast", xlim=c(2016.901, 2017.784), ylim=c(0,100))
ts.plot(subset(trended, start=1, end=length(detrended) - weeks_omit), ylab="Snow depth (in)", main="Snow depth forecast", xlim=c(2016.301, 2017.684), ylim=c(0,120))
lines(pred, type="o", col=2)
polygon(xx, yy, border = 8, col = gray(.6, alpha = .2))
polygon(xxx, yyy, border = 8, col = gray(.6, alpha = .2))
