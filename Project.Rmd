...
# Questions
- What to do with missing values? Skip them? Linear interpolate?
- What to do with residuals?

- Is it stationary? / should some other trend be removed?
- (P)ACF indicating AR(2)? Why no spike at lag 1?

# TODO
- Note that higher order polynomial regressions in t or nonparametric smoothing (linear filtering) could be used in cases where the trend is nonlinear.
